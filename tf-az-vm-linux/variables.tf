...
variable "storage_os_disk" {
    ...
    description = "The storage_os_disk_config settings"
}
...
variable "storage_image_reference" {
    ...
    description = "The storage_image_reference settings"
}

variable "vm_account_credentials" {
    type = object({
        admin_username   = string
        admin_password   = string
    })
    description = "The VM username and password"
}
